            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    returned = Pinky.changespeed(
                        Pinky_directions, False, p_turn, p_steps, 0)
                    p_turn = returned[0]
                    p_steps = returned[1]
                    Pinky.changespeed(Pinky_directions, False, p_turn, p_steps, 0)
                    Pinky.update(wall_list, False)
                if event.key == pygame.K_RIGHT:
                    Pacman.changespeed(30, 0)

                    returned = Pinky.changespeed(
                        Pinky_directions, False, p_turn, p_steps, 1)
                    p_turn = returned[0]
                    p_steps = returned[1]
                    Pinky.changespeed(Pinky_directions, False, p_turn, p_steps, 1)
                    Pinky.update(wall_list, False)
                ...
                if event.key == pygame.K_UP:
                    ...
                    returned = Pinky.changespeed(
                        Pinky_directions, False, p_turn, p_steps, 2)
                    p_turn = returned[0]
                    p_steps = returned[1]
                    Pinky.changespeed(Pinky_directions, False, p_turn, p_steps, 2)
                    Pinky.update(wall_list, False)
                ...
                if event.key == pygame.K_DOWN:
                    ...
                    returned = Pinky.changespeed(
                        Pinky_directions, False, p_turn, p_steps, 3)
                    p_turn = returned[0]
                    p_steps = returned[1]
                    Pinky.changespeed(Pinky_directions, False, p_turn, p_steps, 3)
                    Pinky.update(wall_list, False)
